# Ensure vim is used as default editor
...
# Path mangling
# Dart  - assumes install was used
export DART_HOME=$HOME/workspaces/dart/editor/dart/dart-sdk/bin
...
#Alias
alias gospace="cd $HOME/workspaces/go/src/github.com"
alias dist="cd $HOME/workspaces/dist/"
alias tmux="TERM=screen-256color-bce tmux"

# Google Python SDK - Disabled because of bigsky
#export PYTHONSDKPATH=$HOME/google-cloud-sdk/platform/google_appengine
